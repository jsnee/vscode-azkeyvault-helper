...
(function (ExtensionCommands) {
    ...
    ExtensionCommands.getAllSecrets = getAllSecrets;
    function promptVaultName() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield vscode_1.window.showInputBox({ placeHolder: "Vault Name" });
        });
    }
...
function activate(context) {
    const treeView = vscode_1.window.createTreeView('azkeyvaulthelper', { treeDataProvider: secretExplorerProvider_1.secretExplorerProvider });
    let getSecretsisposable = vscode_1.commands.registerCommand("azkeyvaulthelper.getSecrets", ExtensionCommands_1.ExtensionCommands.getAllSecrets);
